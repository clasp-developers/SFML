...
void CLASP_MAIN()
{
    ...
    package("SF")
	[
	 //Question to drmeister: What do we do with static functions?
	 ...
	 */
	 ...
	 // .def("get-available-devices", &sf::SoundRecorder::getAvailableDevices,
	 //      policies<>(), "", "",
	 ...
	 // .def("get-default-device", &sf::SoundRecorder::getDefaultDevice,
	 //      policies<>(), "", "",
	 ...
	 // .def("is-available", &sf::SoundRecorder::isAvailable,
	 //      policies<>(), "", "",
